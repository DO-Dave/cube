...
{
private:
  // i dont really know when to set something private, ig it could be color?
public:
  ...
  Object(SDL_Rect rect = { 0, 0, 10, 10 },
  ...
  {
    float overlapX = std::min(o1.pos[0] + o1.width - o2.pos[0],
      o2.pos[0] + o2.width - o1.pos[0]);
    float overlapY = std::min(o1.pos[1] + o1.height - o2.pos[1],
      o2.pos[1] + o2.height - o1.pos[1]);
